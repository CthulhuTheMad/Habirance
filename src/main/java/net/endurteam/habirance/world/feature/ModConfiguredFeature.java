...
public class ModConfiguredFeature {
    public static final RuleTest RUSSET = new BlockMatchTest(ModBlocks.RUSSET_BLOCK.get());
    ...
    public static final List<OreConfiguration.TargetBlockState> RUSSET_REPLACEABLES = List.of(
            OreConfiguration.target(ModConfiguredFeature.RUSSET, ModBlocks.RUSSET_REDSTONE_ORE.get().defaultBlockState()));
    ...
    public static final List<OreConfiguration.TargetBlockState> OVERWORLD_RUSSET = List.of(
            OreConfiguration.target(OreFeatures.NATURAL_STONE, ModBlocks.RUSSET_BLOCK.get().defaultBlockState()));
    ...
    public static final ConfiguredFeature<?, ?> ORE_RUSSET = FeatureUtils.register("ore_russet",
            Feature.ORE.configured(new OreConfiguration(OVERWORLD_RUSSET, 64)));
    public static final ConfiguredFeature<?, ?> ORE_REDSTONE_RUSSET = FeatureUtils.register("ore_redstone_russet",
            Feature.ORE.configured(new OreConfiguration(RUSSET_REPLACEABLES, 8)));
    ...
    public static final ConfiguredFeature<?, ?> ORE_SLATE = FeatureUtils.register("ore_slate",
            Feature.ORE.configured(new OreConfiguration(OVERWORLD_SLATE, 40)));
