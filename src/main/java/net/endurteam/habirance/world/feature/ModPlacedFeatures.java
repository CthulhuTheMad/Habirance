...
public class ModPlacedFeatures {
    ...
    public static final PlacedFeature ORE_RUSSET_UPPER_PLACED = PlacementUtils.register("ore_redorck_upper_placed",
            ModConfiguredFeature.ORE_RUSSET.placed(ModOrePlacement.rareOrePlacement(4, HeightRangePlacement.uniform(VerticalAnchor.absolute(64), VerticalAnchor.absolute(128)))));
    public static final PlacedFeature ORE_RUSSET_LOWER_PLACED = PlacementUtils.register("ore_redorck_lower_placed",
            ModConfiguredFeature.ORE_RUSSET.placed(ModOrePlacement.commonOrePlacement(2, HeightRangePlacement.uniform(VerticalAnchor.absolute(0), VerticalAnchor.absolute(60)))));
    public static final PlacedFeature ORE_REDSTONE_RUSSET = PlacementUtils.register("ore_redstone_russet",
            ModConfiguredFeature.ORE_REDSTONE_RUSSET.placed(ModOrePlacement.commonOrePlacement(4, HeightRangePlacement.uniform(VerticalAnchor.bottom(), VerticalAnchor.absolute(15)))));
